...
#' 
#' @import shiny shinydashboard shinythemes utils owmr jsonlite zoo dplyr tidyr leaflet 
...
cherrycoldhardiness <- function() {
                  ...
                  navbarPage("Sweet Cherry Cold Hardiness Estimations",
                             ...
                             tabPanel(strong("About"),
                                        ...
                                        p("The cold hardiness of perennial plants refers to their ability to 
                                          ...
                                          the Okanagan Valley of British Columbia.", style = "font-size:17px;color:black;"),
                                        ...
                                        temperatures from the day before and calculations of the daily chilling and heat requirement accumulation based on models developed by", style = "font-size:17px;color:black;",
                                        a(href ="https://www.researchgate.net/publication/282060426_Development_of_chilling_and_forcing_relationships_for_modeling_spring_phenology_of_apple_and_sweet_cherry", "Neilsen et al. (2015)", style = "font-size:17px;"),
                                        ...
                                        p("Questions and comments about this website can be sent to Elizabeth Houghton (elizabeth.houghton@ubc.ca).
                                          The website source content can be viewed on", style = "font-size:17px;color:black;",
                                          a(href="https://github.com/ElizabethHoughton/cherry-cold-hardiness", "GitHub", style = "font-size:17px;"), #active weblink to GitHub
                                          ".", style = "font-size:17px;color:black;"),
                                        # imageOutput("orchard", width="100%"), (placeholder if you want images later)
                                      br(),
                                        h4("Disclaimer", style = "color:black;"),
                                        p("This website, its content contributers, and web developers are not liable to any damages resulting from the use of
                                          the information provided in this application. Users are encouraged to seek advice from the appropriate experts if they do not
                                          feel certain about the predictions made using the provided models.", style = "font-size:15px;color:black;")),
                             # second tab panel
                             tabPanel(strong("How to Use"),
                                        ...
                                        a CSV file in the same format as the following template:", style = "font-size:17px;color:black;"),
                                        br(),
                                        downloadButton("downloadTemplate", 
                                                       "Download file template"),
                                        h3("Don't have your own data?", style = "color:black;font-size:27px;"),
                                        p("That's okay! Choose one of four loactions currently available and hourly temperature data from the", style = "font-size:17px;color:black;",
                                          a(href="https://climate.weather.gc.ca/historical_data/search_historic_data_e.html", "Government of Canada's Historical Database", style = "font-size:17px;"),
                                        "will be used in the model. This option may take up to a few minutes to run. You can find the exact weather stations used at each location here:", style = "font-size:17px;color:black;",
                                          a(href="https://climate.weather.gc.ca/climate_data/hourly_data_e.html?hlyRange=2007-11-30%7C2021-08-03&dlyRange=2005-01-01%7C2021-08-02&mlyRange=%7C&StationID=46987&Prov=BC&urlExtension=_e.html&searchType=stnName&optLimit=yearRange&StartYear=1840&EndYear=2021&selRowPerPage=25&Line=2&searchMethod=contains&Month=8&Day=3&txtStationName=vernon&timeframe=1&Year=2021", "Vernon", style = "font-size:17px;"),
                                          ",",
                             ...
                             tabPanel(
                               ...
                               sidebarLayout(
                                 sidebarPanel(
                                   ...
                                   selectInput("location", "Or Select Closest Weather Station", choices = c("Not Selected"= "not_sel",
                                                                                   "Penticton"="penticton",
                                   ...
                                   br(),
                                   h5("Weather station locations", style = "font-size:15px;margin-top: 16%"),
                                   leafletOutput("map")
                                 ),
                                 mainPanel(
                                   tabsetPanel(
  ...
  {#select for values greater than or equal to Sys.Date()
   ...
   # par(mar = c(7, 5, 4, 2), oma = c(10, 0, 0, 1), cex=1.1) # set margins so that there is room for figure caption
    ...
    legend("bottomleft", legend=c("LT10 (Recorded Weather)", "LT10 (Weather Predictions)", "Daily Minimum Temperature"), 
           col=c("black", "red","blue"), lty=c(1, 1, 1), lwd=c(2.5, 2.5, 2.5), cex=1, bty = "n") # add legend
  }
  ...
  {#select for values greater than or equal to Sys.Date()
    ...
    legend("bottomleft", legend=c("LT50 (Recorded Weather)", "LT50 (Weather Predictions)", "Daily Minimum Temperature"), 
           col=c("black", "red","blue"), lty=c(1, 1, 1), lwd=c(2.5, 2.5, 2.5), cex=1, bty = "n") # add legend
  }
  ...
  {#select for values greater than or equal to Sys.Date()
    ...
    legend("bottomleft", legend=c("LT90 (Recorded Weather)", "LT90 (Weather Predictions)", "Daily Minimum Temperature"), 
           col=c("black", "red","blue"), lty=c(1, 1, 1), lwd=c(2.5, 2.5, 2.5), cex=1, bty = "n") # add legend
  ...
  server <- function(input, output, session) {
    ...
    #render image, can add images later if wanted
   ...
   # }, deleteFile = FALSE)
    ...
    # render map
    map_data <- read.csv(file = './data/Map.csv')
    ...
    output$downloadData <- downloadHandler(
      filename = function() {
        paste("Lethal_Temp_Estimates_", Calculated_LT10()$Station.Name, ".csv", sep = "")
      },
